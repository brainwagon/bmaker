...
- **Style:** Avoid slang or overly technical jargon. Use clear, full sentences that guide the user through the design process.
...
## Accessibility
- **Standard Compliance:** All components must use semantic HTML and proper ARIA roles to ensure the app is usable by everyone, regardless of the tools they use.
- **Contrast:** Ensure all text and UI elements meet minimum WCAG accessibility standards for contrast.
- **Focus:** Maintain a clear and predictable focus order for keyboard navigation.
